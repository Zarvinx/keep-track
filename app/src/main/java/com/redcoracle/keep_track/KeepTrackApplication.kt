...
@HiltAndroidApp
class KeepTrackApplication : Application(), ImageLoaderFactory {
    ...
    companion object {
        private val TAG = KeepTrackApplication::class.java.name
        
        @JvmStatic
        lateinit var instance: KeepTrackApplication
            private set
    }
}
